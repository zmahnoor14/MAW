    ...
    if os.path.exists(msp_file):
        ...
        for mz, row in msp.iterrows():
            ...
            if os.path.exists(mbank_dir):
                ...
                files_m = [item for item in files_m if 'proc' not in item]
                for mz, row in msp.iterrows():
...
#parser.add_argument('--sirius_candidate_json', type=str, action='append', help='path to MetFrag candidate table CSV file')
parser.add_argument('--ms1data', type=str, help='path to MS1 data CSV file')
parser.add_argument('--db', type=str, help='name of database used for SIRIUS')
...
#sirius_candidate_json = args.sirius_candidate_json
...
#print(msp_file_df)
print("sirius_postproc starts")
ms1data_df = sirius_postproc(ms1data, sirius_candidate_json, file_id, db)
#print(ms1data_df)
print("CandidateSelection starts")
CandidateSelection_SimilarityandIdentity(file_id = file_id, msp_file = msp_file_df, 
