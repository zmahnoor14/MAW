...
7. (optional) Sl_metfrag.txt (This file contains the InChIKeys for all SMILES in the suspect list is generated by the python function - slist_metfrag) for MetFrag
